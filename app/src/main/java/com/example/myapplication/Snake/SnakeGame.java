...
public class SnakeGame extends ApplicationAdapter {
	...
	public void create() {
		...
		snakeHead = new Texture(Gdx.files.internal("snake/snakehead.png"));
		apple = new Texture(Gdx.files.internal("snake/apple.png"));
		snakeBody = new Texture(Gdx.files.internal("snake/snakebody.png"));
