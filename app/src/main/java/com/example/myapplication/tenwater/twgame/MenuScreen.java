...
import com.example.myapplication.tenwater.twgame.stage.ChooseLevelStage;
...
public class MenuScreen extends AbstractBaseScreen {
    ...
    public void show() {
        ...
        /**
         * ±ØÐëÉèÖÃListenerµã»÷ImageButtonÊ±imageUpºÍimageDown²Å»áÇÐ»»
         */
        ...
        // ÉèÖÃÁËcheckedÍ¼Æ¬Ö®ºó£¬×Ô¶¯´¥·¢toggleº¯Êý
        ...
        tabel = new Table();
        tabel.setDebug(game.debug);  // ÉèÖÃdebugÄ£Ê½£¬ÕâÑù»áÔÚActorÍâÃæ»æÖÆ²»Í¬ÑÕÉ«µÄÏßÀ´Çø·Ö
        tabel.row().padTop(150f);  // µÚÒ»¸öcell¾àÀëtopµÄ¾àÀë
