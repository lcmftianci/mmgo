...
public class AssetsManager implements Disposable, AssetErrorListener {
    ...
    public void loadGameResources(AssetManager assetManager) {
        ...
        assetManager.setErrorListener(this);  // Èç¹û¼ÓÔØ×ÊÔ´³ö´í,³ÌÐò½«»áÔÝÍ£ÔÚÄÄÀï£¬²»»áÍË³ö£¬²¢ÇÒµ÷ÓÃerror·½·¨
        ...
        // ¼ÓÔØÓÎÏ·Ñ¡¹ØµÄ±³¾°£¬ Â·¾¶Î´¶¨ÒåÔÚResourcesÀàÀïÃæ
...
//        assetManager.finishLoading();  //´Ë´¦²»Ó¦¸ÃÓÐ´Ëº¯Êý£¬·ñÔò¼ÓÔØµÄScreen²»»áÏÔÊ¾
        
        
    }
   
    /**
     * get×ÊÔ´Òª·ÅÔÚmanager.updateÀïÃæÖ´ÐÐ
     */
    public void init() {
    ...
    public class AssetsBg {
        ...
        // ÄÚ²¿Àà¿ÉÒÔÖ±½Ó·ÃÎÊÍâ²¿ÀàµÄ³ÉÔ±£¬ÆäÊµÕâÀïÒ²¿ÉÒÔÖ±½ÓÓÃ assetManager
