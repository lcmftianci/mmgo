...
import alex.com.gdxdemo.fireworks.GiftParticleEffectView;
import alex.com.gdxdemo.fireworks.GiftParticleFragment;
...
public class FireWorksActivity extends FragmentActivity implements AndroidFragmentApplication.Callbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpringEffect.doEffectSticky(findViewById(R.id.btn1), new Runnable() {
            @Override
            public void run() {
                NormalActivity.launch(FireWorksActivity.this);
            }
        });
        ...
        SpringEffect.doEffectSticky(findViewById(R.id.btn2), new Runnable() {
            @Override
            public void run() {
                HalfScreenActivity.launch(FireWorksActivity.this);
            }
        });
