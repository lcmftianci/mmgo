...
import alex.com.gdxdemo.balloon.BalloonParticleContants;
import alex.com.gdxdemo.balloon.BalloonParticleEvents;
import alex.com.gdxdemo.balloon.BalloonParticleFragment;
import alex.com.gdxdemo.fireworks.GiftParticleContants;
import alex.com.gdxdemo.testcode.SpringEffect;
import de.greenrobot.event.EventBus;


public class BalloonActivity extends FragmentActivity implements AndroidFragmentApplication.Callbacks{
	...
	public static void launch(Context context) {
		...
		intent.setClass(context, BalloonActivity.class);
...
//			float[] randomColor = mRandomColors.get( (int)(Math.random()*(mRandomColors.size()) ) );
    ...
    public class SystemReceiveBroadCast extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d(BalloonActivity.class.getSimpleName(), "SystemReceiveBroadCast[^^^^^^^]play Particle Receive: " + intent.getAction());
